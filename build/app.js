...
angular.module('app.house').controller('HouseGlobalController', function ($scope, $http, $q, SmartMapStyle) {
    $scope.demoTree2 = [
...
angular.module('app.house').factory('SmartMapStyle', function ($q, $http, APP_CONFIG) {
